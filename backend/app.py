...
def _seed_defaults():
    ...
    if not Role.query.first():
        admin_role = Role(name="admin", description="Accès complet au système", is_system=True)
        user_role = Role(name="utilisateur", description="Accès utilisateur standard", is_system=True)
